...
#pragma omp parallel for num_threads(NUM_SEARCH_THREADS) schedule(dynamic)
  ...
  std::cerr << std::setw(4) << "Ls" << std::setw(12) << "Beam_width" << std::setw(12) << "QPS " << std::setw(18) << "Mean Lat(us)" << std::setw(12)
  ...
  std::cerr << "==============================================================="
               "==================================================="
            << std::endl;
  std::cerr << std::setw(4) << L << std::setw(12) << beam_width << std::setw(12) << qps << std::setw(18)
