  ...
  class DynamicSSDIndex {
    ...
    */
    DynamicSSDIndex(Parameters &parameters, const std::string disk_prefix_in, const std::string disk_prefix_out,
                    Distance<T> *dist, dirann::Metric disk_metric, int search_mode = BEAM_SEARCH,
   ...
   public:
    ...
    dirann::Metric _dist_metric;
    Distance<T> *_dist_comp;

    dirann::Parameters _paras_mem;
    dirann::Parameters _paras_disk;
